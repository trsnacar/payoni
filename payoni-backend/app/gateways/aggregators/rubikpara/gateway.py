"""RubikPara payment gateway — API key auth."""
import httpx
...
class RubikParaGateway(BaseGateway):
    SANDBOX_BASE = "https://sandbox.rubikpara.com/api"
    PRODUCTION_BASE = "https://api.rubikpara.com/api"
    ...
    def _build_response(self, data: dict) -> GatewayResponse:
        approved = data.get("success") is True or data.get("resultCode") == "00"
